...
CREATE TABLE `block0` (
  ...
  `crawlBlock` tinyint(4) DEFAULT '1',
  `crawlTrace` tinyint(4) DEFAULT '1',
  `crawlFeed` tinyint(4) DEFAULT '1',
...
CREATE TABLE `blockunfinalized` (
  ...
  `numTransactionsEVM` int(11) DEFAULT NULL,
  `numTransactionsInternalEVM` int(11) DEFAULT NULL,
  `numReceiptsEVM` int(11) DEFAULT NULL,
